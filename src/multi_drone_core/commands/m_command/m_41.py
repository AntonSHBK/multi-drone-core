...
class M41_EmergencyLand(BaseCommand):
    """
    Команда EMERGENCY LAND.
    """
    ...
    def __init__(self, counter: int = 0):
        super().__init__(name="M41", counter=counter, is_special_command=True)
        self.description = "Emergency land"
    ...
    @classmethod
    def from_dict(cls, data: dict) -> "M41_EmergencyLand":
        return cls(counter=data.get("counter", 0))

    def __repr__(self) -> str:
        return f"M41_EmergencyLand(counter={self.counter}, complete={self.complete})"
